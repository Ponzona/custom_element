...
const ERROR = {
	EMPTY_STRING: `<p>Nope. Try again!</p>`,
	NOT_FOUND: `<p>Country wasn't found. So enjoy this random envelope!</p>`,
}
...
function findCountryData(country) {
	const countryDataIndex = countries.findIndex((el) => country.toLowerCase() === el.name.toLowerCase());
